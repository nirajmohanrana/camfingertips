...
export const DEFAULT_QUADS: QuadConfig[] = [
  {
    ...
    landmarkB: INDEX_TIP,
    enabled: true,
    filterPreset: 'particleEngine',
    filterStrength: 1,
    customFilter: { ...DEFAULT_CUSTOM_FILTER },
    borderColor: [59, 130, 246],
    borderOpacity: 0.9,
    borderWidth: 3,
    text: { ...DEFAULT_QUAD_TEXT, content: 'POP_VOLUME_01' },
  },
  {
    id: 'quad2',
    label: 'Index + Middle',
    ...
    borderOpacity: 0.9,
    borderWidth: 3,
    text: { ...DEFAULT_QUAD_TEXT, content: 'POP_VOLUME_02' },
  },
  {
    id: 'quad3',
    label: 'Middle + Ring',
    ...
    borderOpacity: 0.9,
    borderWidth: 3,
    text: { ...DEFAULT_QUAD_TEXT, content: 'POP_VOLUME_03' },
  },
]
